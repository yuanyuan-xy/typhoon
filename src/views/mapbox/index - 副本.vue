...
export default {
  ...
  methods: {
    ...
    addLayer1() {
      this.removePoint()
      var pointArr = [
          {name: "自作里陆航机场", lon: 127.1761, lat: 37.8656, gd: 100, country: "KOR"},
          {name: "全州陆航机场", lon: 127.1192, lat: 35.8783, gd: 100, country: "KOR"},
          {name: "清州空军机场", lon: 127.4997, lat: 36.5686, gd: 100, country: "KOR"},
          {name: "南旨空军机场", lon: 128.5103, lat: 35.4292, gd: 100, country: "KOR"},
          {name: "论山陆航机场", lon: 127.1125, lat: 36.2678, gd: 100, country: "KOR"},
          {name: "阿普拉海军基地", lon: 144.668, lat: 13.4375, gd: 10, country: "USA"},
          {name: "阿普拉海军基地", lon: -122.48369693756104, lat: 37.83381888486939, gd: 10, country: "USA"},
          {name: "阿普拉海军基地", lon: -67.13734351262877, lat: 45.137451890638886, gd: 10, country: "USA"},
        ]
    ...
    addWind () {
      ...
      var data = [];  
      $.getJSON('https://iclient.supermap.io/examples/data/globalWindData.json', (windData) => {
          // console.log(echarts) 
          var p = 0;
          var maxMag = 0;
          var minMag = Infinity;
